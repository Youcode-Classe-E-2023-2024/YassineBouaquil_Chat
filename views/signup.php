<?php
    if(file_exists('controllers/constants.php'))require 'controllers/constants.php';
    else require '../controllers/constants.php';
...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <form class="max-w-xl mx-auto p-10 bg-white rounded-md shadow-md" action="<?= ROOT_URL ?>controllers/signController/signup-logic.php" enctype="multipart/form-data" method="post">
        ...
        <p class="mt-4 text-gray-600 text-center">Already have an account? <a <?php if(file_exists('signin.php'))echo 'href="signin.php"';else echo 'href="views/signin.php"'; ?> class="text-blue-500">Sign In</a></p>
    </form>
</body>
</html>